<script>
    $(document).ready(function() {
        ...
        // overview is the home (default active) tab
        var home = $("#tab-overview");
        // when user click on home tab
        home.click(function() {
            // set content filename
            var fn = baseURL+baseDir+"index.php?page=template-overview&hideWrapper=1";
            // load file into content tab
...
if (isset($_POST['save']) && (isset($_GET['action']) && (isset($_GET['id']))))
{
    if (isset($_POST) && (!empty($_POST)))
    {
        ...
        // SAVE CSS FILE
        \YAWK\alert::draw("info", "css file", "should be written in this stage", '', 8000);
        ////////////////////////////////////////////////////////////////////////////////////////
