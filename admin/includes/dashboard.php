...
<div class="row">
    <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
            <span class="info-box-icon bg-blue"><i class="fa fa-facebook-official"></i></span>

            <div class="info-box-content">
                <span class="info-box-text">Facebook </span>
                <span class="info-box-number">126.436 <small> Friends</small></span>
            </div>
            <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">41.410 <small> Follower</small></span>
            </div>
            <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
...
<div class="row">
                    ...
                    <div class="box-body">
                        ...
                        <div class="direct-chat-messages">
                            ...
                            <div class="direct-chat-msg">
                                ...
                                <!-- /.direct-chat-info -->
                                <img class="direct-chat-img" src="../system/engines/AdminLTE/dist/img/user1-128x128.jpg" alt="message user image"><!-- /.direct-chat-img -->
                            ...
                            <div class="direct-chat-msg right">
                                ...
                                <!-- /.direct-chat-info -->
                                <img class="direct-chat-img" src="../system/engines/AdminLTE/dist/img/user3-128x128.jpg" alt="message user image"><!-- /.direct-chat-img -->
                                <div class="direct-chat-text">
                        ...
                        <div class="direct-chat-contacts">
                            <ul class="contacts-list">
                                <li>
                                    <a href="#">
                                        <img class="contacts-list-img" src="../system/engines/AdminLTE/dist/img/user1-128x128.jpg" alt="User Image">
                                ...
                                <li>
                                    <a href="#">
                                        <img class="contacts-list-img" src="../system/engines/AdminLTE/dist/img/user7-128x128.jpg" alt="User Image">
                                ...
                                <li>
                                    <a href="#">
                                        <img class="contacts-list-img" src="../system/engines/AdminLTE/dist/img/user3-128x128.jpg" alt="User Image">
                                ...
                                <li>
                                    <a href="#">
                                        <img class="contacts-list-img" src="../system/engines/AdminLTE/dist/img/user5-128x128.jpg" alt="User Image">
                                ...
                                <li>
                                    <a href="#">
                                        <img class="contacts-list-img" src="../system/engines/AdminLTE/dist/img/user6-128x128.jpg" alt="User Image">
                                ...
                                <li>
                                    <a href="#">
                                        <img class="contacts-list-img" src="../system/engines/AdminLTE/dist/img/user8-128x128.jpg" alt="User Image">
    ...
    <div class="col-md-4">
        ...
        $stats->drawBrowserBox($db, $data, 200); ?>
