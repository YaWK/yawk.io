...
{   // check and delete settings file if needed
    ...
    $h1Font = \YAWK\template::setCssFontTags("h1", $tplSettings);
    $h2Font = \YAWK\template::setCssFontTags("h2", $tplSettings);
    $h3Font = \YAWK\template::setCssFontTags("h3", $tplSettings);
    $h4Font = \YAWK\template::setCssFontTags("h4", $tplSettings);
    $h5Font = \YAWK\template::setCssFontTags("h5", $tplSettings);
    $h6Font = \YAWK\template::setCssFontTags("h6", $tplSettings);
    ...
    body {   
        ...
        /* BODY SETTINGS */
        color: #".$tplSettings['text-fontcolor'].";
        background-color: #".$tplSettings['body-bg-color'].";
        text-shadow: ".$tplSettings['body-text-shadow']." #".$tplSettings['body-text-shadow-color'].";
        font-size: ".$tplSettings['body-text-size'].";
        filter: dropshadow(color=#".$tplSettings['body-text-shadow-color'].", offx=1, offy=1);
        ...
        a { /* LINK SETTINGS */
            ...
            font-weight: bold;
            text-decoration: ".$tplSettings['decoration-link'].";
        }
        a:visited {
            color: #".$tplSettings['visited-link'].";
        }
       ...
       .h6 .small {
           font-weight: normal;
           line-height: 1;
           color: #".$tplSettings['smalltag-fontcolor'].";
       }
    /* MAIN BOX SHADOW SETTINGS */
    #main-pos {
        box-shadow: ".$tplSettings['main-box-shadow']." #".$tplSettings['main-box-shadow-color'].";
    }
    #footer {
        box-shadow: ".$tplSettings['main-box-shadow']." #".$tplSettings['main-box-shadow-color'].";
    }
