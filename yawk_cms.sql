...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 22. Sep 2016 um 21:26
...
INSERT INTO `cms_settings` (`property`, `value`, `longValue`, `type`, `sortation`, `activated`, `label`, `icon`, `heading`, `subtext`, `fieldClass`, `fieldType`, `placeholder`, `description`) VALUES
...
('offlineimage', 'media/images/closed-sign-tm.jpg', '', 8, 0, 1, 'OFFLINEIMAGE_LABEL', '', '', '', 'form-control', 'input', '', 'OFFLINEIMAGE_DESC'),
('offlinemsg', '<h1>Wartungsarbeiten</h1><h3>Bitte schau sp&auml;ter nochmal vorbei.</h3>', '', 8, 0, 1, 'OFFLINEMSG_LABEL', '', '', '', 'form-control', 'input', '', ''),
