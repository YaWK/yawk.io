...
<table width="100%" cellpadding="4" cellspacing="0" border="0" class="table table-hover" id="table-sort">
    ...
    <tr>
        ...
        <td width="5%" style="text-align:center;"><strong><?PHP print $lang['BOOKING_DATEWISH']; ?></strong></td>
        <td width="5%" style="text-align:center;"><strong><?PHP print $lang['BOOKING_TODO']; ?></strong></td>
        <td width="39%"><strong><?PHP print $lang['MESSAGE']; ?></strong></td>
        <td width="5%" style="text-align:center;"><strong><?PHP print $lang['BOOKING_VISITS']; ?></strong></td>
        <td width="5%" style="text-align:center;"><strong><?PHP print $lang['IP']; ?></strong></td>
        <td width="14%" style="text-align:center;"><strong><?PHP print $lang['ACTIONS']; ?></strong></td>
    </tr>
    </thead>
    <tbody>
