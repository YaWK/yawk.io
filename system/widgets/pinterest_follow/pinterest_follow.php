<?php
// set default values
$pinterestFollowUrl="https://www.pinterest.com/pinterest/";
$heading = '';
$subtext = '';
    ...
    {   // set widget properties and values into vars
        ...
        if (isset($w_property)){
            switch($w_property)
            {
                ...
                case 'pinterestFollowUrl';
                    $pinterestFollowUrl = $w_value;
                    break;

                /* heading */
                case 'pinterestFollowHeading';
                    $heading = $w_value;
                    break;

                /* subtext */
                case 'pinterestFollowSubtext';
                    $subtext = $w_value;
                    break;
            }
        } /* END LOAD PROPERTIES */
...
echo $headline;
?>
<a data-pin-do="buttonFollow" href="<?php echo $pinterestFollowUrl;?>">Pinterest</a>
