...
?>
  ...
  <div class="container-fluid">
      ...
      <div class="row">
          ...
          <div class="<?php echo $col; ?>">
              <div class="row">
                  <?php
                  // POSITION: intro
                  \YAWK\template::getPositionDivBox($db, $lang, "intro", 1, "col-md-12", $positions, $indicators);

                  // POSITION: globalmenu
                  \YAWK\template::getPositionDivBox($db, $lang, "globalmenu", 1, "col-md-12", $positions, $indicators);

                  // POSITION: top
                  \YAWK\template::getPositionDivBox($db, $lang, "top", 1, "col-md-12", $positions, $indicators);
                  ?>
              </div>
              <div class="row">
                  <?php
                  // POSITION: leftMenu
                  \YAWK\template::getPositionDivBox($db, $lang, "leftMenu", 0, "col-md-2", $positions, $indicators);
                  ?>
                  <!-- <div class="col-md-2 posbox" id="pos_outerLeft" style="height: 630px; margin-bottom:5px; text-align: center;">&laquo;outerLeft&raquo;</div> -->
                  <?php
                  ...
                  <!-- <div class="col-md-8" style="height: auto; margin-bottom:5px; text-align: center;"> -->
                      <div class="row">
                          <?php
                          // POSITION: mainTop
                          \YAWK\template::getPositionDivBox($db, $lang, "mainTop", 1, "col-md-12", $positions, $indicators);
                          ?>
                      ...
                      <div class="row">
                          ...
                          if ($positions['pos-mainTopLeft-enabled'] === "1" && ($positions['pos-mainTopCenter-enabled'] === "1") && ($positions['pos-mainTopRight-enabled'] === "1"))
                          {
                              ...
                              \YAWK\template::getPositionDivBox($db, $lang, "mainTopLeft", 0, "col-md-4", $positions, $indicators);
                              // POSITION: mainTopCenter
                              \YAWK\template::getPositionDivBox($db, $lang, "mainTopCenter", 0, "col-md-4", $positions, $indicators);
                              // POSITION: mainTopRight
                              \YAWK\template::getPositionDivBox($db, $lang, "mainTopRight", 0, "col-md-4", $positions, $indicators);
                          }
                          else if ($positions['pos-mainTopLeft-enabled'] === "1" && ($positions['pos-mainTopCenter-enabled'] === "0") && ($positions['pos-mainTopRight-enabled'] === "0"))
                          {
                              // POSITION: mainTopLeft
                              \YAWK\template::getPositionDivBox($db, $lang, "mainTopLeft", 0, "col-md-12", $positions, $indicators);
                          }
                          else if ($positions['pos-mainTopLeft-enabled'] === "0" && ($positions['pos-mainTopCenter-enabled'] === "1") && ($positions['pos-mainTopRight-enabled'] === "0"))
                          {
                              // POSITION: mainTopCenter
                              \YAWK\template::getPositionDivBox($db, $lang, "mainTopCenter", 0, "col-md-12", $positions, $indicators);
                          }
                          else if ($positions['pos-mainTopLeft-enabled'] === "0" && ($positions['pos-mainTopCenter-enabled'] === "0") && ($positions['pos-mainTopRight-enabled'] === "1"))
                          {
                              // POSITION: mainTopRight
                              \YAWK\template::getPositionDivBox($db, $lang, "mainTopRight", 0, "col-md-12", $positions, $indicators);
                          }
                          else if ($positions['pos-mainTopLeft-enabled'] === "1" && ($positions['pos-mainTopCenter-enabled'] === "1") && ($positions['pos-mainTopRight-enabled'] === "0"))
                          {
                              // POSITION: mainTopLeft
                              \YAWK\template::getPositionDivBox($db, $lang, "mainTopLeft", 0, "col-md-6", $positions, $indicators);
                              // POSITION: mainTopCenter
                              \YAWK\template::getPositionDivBox($db, $lang, "mainTopCenter", 0, "col-md-6", $positions, $indicators);
                          }
                          else if ($positions['pos-mainTopLeft-enabled'] === "0" && ($positions['pos-mainTopCenter-enabled'] === "1") && ($positions['pos-mainTopRight-enabled'] === "1"))
                          {
                              ...
                              \YAWK\template::getPositionDivBox($db, $lang, "mainTopCenter", 0, "col-md-6", $positions, $indicators);
                              // POSITION: mainTopRight
                              \YAWK\template::getPositionDivBox($db, $lang, "mainTopRight", 0, "col-md-6", $positions, $indicators);
                          }
                      ...
                      <div class="row">
                          <?php
                          // POSITION: mainBottom
                          \YAWK\template::getPositionDivBox($db, $lang, "mainBottom", 0, "col-md-12", $positions, $indicators);
                          ?>
                      </div>
                      <div class="row">
                          <?php
                          if ($positions['pos-mainBottomLeft-enabled'] === "1" && ($positions['pos-mainBottomCenter-enabled'] === "1") && ($positions['pos-mainBottomRight-enabled'] === "1"))
                          {
                              ...
                              \YAWK\template::getPositionDivBox($db, $lang, "mainBottomLeft", 0, "col-md-4", $positions, $indicators);
                              // POSITION: mainBottomCenter
                              \YAWK\template::getPositionDivBox($db, $lang, "mainBottomCenter", 0, "col-md-4", $positions, $indicators);
                              // POSITION: mainBottomRight
                              \YAWK\template::getPositionDivBox($db, $lang, "mainBottomRight", 0, "col-md-4", $positions, $indicators);
                          }
                          ...
                          {
                              // POSITION: mainTopLeft
                              \YAWK\template::getPositionDivBox($db, $lang, "mainBottomLeft", 0, "col-md-12", $positions, $indicators);
                          }
                          ...
                          {
                              // POSITION: mainTopCenter
                              \YAWK\template::getPositionDivBox($db, $lang, "mainBottomCenter", 0, "col-md-12", $positions, $indicators);
                          }
                          ...
                          {
                              // POSITION: mainTopRight
                              \YAWK\template::getPositionDivBox($db, $lang, "mainBottomRight", 0, "col-md-12", $positions, $indicators);
                          }
                          ...
                          {
                              // POSITION: mainTopLeft
                              \YAWK\template::getPositionDivBox($db, $lang, "mainBottomLeft", 0, "col-md-6", $positions, $indicators);
                              // POSITION: mainTopCenter
                              \YAWK\template::getPositionDivBox($db, $lang, "mainBottomCenter", 0, "col-md-6", $positions, $indicators);
                          }
                          else if ($positions['pos-mainBottomLeft-enabled'] === "0" && ($positions['pos-mainBottomCenter-enabled'] === "1") && ($positions['pos-mainBottomRight-enabled'] === "1"))
                          {
                              ...
                              \YAWK\template::getPositionDivBox($db, $lang, "mainBottomCenter", 0, "col-md-6", $positions, $indicators);
                              // POSITION: mainTopRight
                              \YAWK\template::getPositionDivBox($db, $lang, "mainBottomRight", 0, "col-md-6", $positions, $indicators);
                          }
                      ...
                      <div class="row">
                          <?php
                          // POSITION: mainFooter
                          \YAWK\template::getPositionDivBox($db, $lang, "mainFooter", 0, "col-md-12", $positions, $indicators);
                          ?>
                      </div>
                      <div class="row">
                          <?php
                          if ($positions['pos-mainFooterLeft-enabled'] === "1" && ($positions['pos-mainFooterCenter-enabled'] === "1") && ($positions['pos-mainFooterRight-enabled'] === "1"))
                          {
                              ...
                              \YAWK\template::getPositionDivBox($db, $lang, "mainFooterLeft", 0, "col-md-4", $positions, $indicators);
                              // POSITION: mainFooterCenter
                              \YAWK\template::getPositionDivBox($db, $lang, "mainFooterCenter", 0, "col-md-4", $positions, $indicators);
                              // POSITION: mainFooterRight
                              \YAWK\template::getPositionDivBox($db, $lang, "mainFooterRight", 0, "col-md-4", $positions, $indicators);
                          }
                          ...
                          {
                              // POSITION: mainTopLeft
                              \YAWK\template::getPositionDivBox($db, $lang, "mainFooterLeft", 0, "col-md-12", $positions, $indicators);
                          }
                          ...
                          {
                              // POSITION: mainTopCenter
                              \YAWK\template::getPositionDivBox($db, $lang, "mainFooterCenter", 0, "col-md-12", $positions, $indicators);
                          }
                          ...
                          {
                              // POSITION: mainTopRight
                              \YAWK\template::getPositionDivBox($db, $lang, "mainFooterRight", 0, "col-md-12", $positions, $indicators);
                          }
                          ...
                          {
                              // POSITION: mainTopLeft
                              \YAWK\template::getPositionDivBox($db, $lang, "mainFooterLeft", 0, "col-md-6", $positions, $indicators);
                              // POSITION: mainTopCenter
                              \YAWK\template::getPositionDivBox($db, $lang, "mainFooterCenter", 0, "col-md-6", $positions, $indicators);
                          }
                          else if ($positions['pos-mainFooterLeft-enabled'] === "0" && ($positions['pos-mainFooterCenter-enabled'] === "1") && ($positions['pos-mainFooterRight-enabled'] === "1"))
                          {
                              ...
                              \YAWK\template::getPositionDivBox($db, $lang, "mainFooterCenter", 0, "col-md-6", $positions, $indicators);
                              // POSITION: mainTopRight
                              \YAWK\template::getPositionDivBox($db, $lang, "mainFooterRight", 0, "col-md-6", $positions, $indicators);
                          }
                  ...
                  <?php
                  // POSITION: outerLeft
                  \YAWK\template::getPositionDivBox($db, $lang, "rightMenu", 0, "col-md-2", $positions, $indicators);
                  ?>
              ...
              <div class="row">
                  <?php
                  // POSITION: footer
                  \YAWK\template::getPositionDivBox($db, $lang, "footer", 0, "col-md-12", $positions, $indicators);
                  ?>
              </div>
              <div class="row">
                  <?php
                  // POSITION: hiddenToolbar
                  \YAWK\template::getPositionDivBox($db, $lang, "hiddenToolbar", 0, "col-md-12", $positions, $indicators);
                  ?>
              </div>
              <div class="row">
                  <?php
                  // POSITION: debug
                  \YAWK\template::getPositionDivBox($db, $lang, "debug", 0, "col-md-12", $positions, $indicators);
                  ?>
              </div>
          </div>
          ...
          <?php
          // POSITION: outerRight
          \YAWK\template::getPositionDivBox($db, $lang, "outerRight", 0, "col-md-2", $positions, $indicators);
          ?>
      ...
      <div class="row">
          ...
          \YAWK\template::getPositionDivBox($db, $lang, "outerBottom", 0, "col-md-12", $positions, $indicators);
          ?>
      </div>
  </div>
