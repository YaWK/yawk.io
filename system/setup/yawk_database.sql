...
('fbEventsShowCover', '', 39, 1, 6, 'LABEL_FB_EVENTS_SHOW_COVER', '', '', '', 'DESC_FB_EVENTS_SHOW_COVER', 'form-control', 'select', '', 'true,true:false,false', 190),
('fbEventsShowCounter', '', 39, 1, 7, 'LABEL_FB_EVENTS_SHOW_COUNTER', '', '', '', 'DESC_FB_EVENTS_SHOW_COUNTER', 'form-control', 'select', '', 'true,true:false,false', 191),
