...
('socialBarHeading', '', 35, 1, 0, 'LABEL_SOCIALBAR_HEADING', 'fa fa-wrench', 'TITLE_SOCIALBAR_SETTINGS', '', 'DESC_SOCIALBAR_HEADING', 'form-control', '', 'PH_SOCIALBAR_HEADING', '', 172),
...
('socialBarSubtext', '', 35, 1, 0, 'LABEL_SOCIALBAR_SUBTEXT', '', '', '', 'DESC_SOCIALBAR_SUBTEXT', 'form-control', '', 'PH_SOCIALBAR_SUBTEXT', '', 312),
('socialBarFacebookUrl', '', 35, 1, 1, 'LABEL_SOCIALBAR_FACEBOOK', 'fa fa-facebook-official', 'TITLE_FACEBOOK', '', 'DESC_SOCIALBAR_FACEBOOK', 'form-control', '', 'PH_SOCIALBAR_FACEBOOK', '', 313),
('socialBarYouTubeUrl', '', 35, 1, 20, 'LABEL_SOCIALBAR_YOUTUBE', 'fa fa-youtube', 'TITLE_YOUTUBE', '', 'DESC_SOCIALBAR_YOUTUBE', 'form-control', '', 'PH_SOCIALBAR_YOUTUBE', '', 314),
('socialBarPinterestUrl', '', 35, 1, 30, 'LABEL_SOCIALBAR_PINTEREST', 'fa fa-pinterest', 'TITLE_PINTEREST', '', 'DESC_SOCIALBAR_PINTEREST', 'form-control', '', 'PH_SOCIALBAR_PINTEREST', '', 315),
('socialBarInstagramUrl', '', 35, 1, 40, 'LABEL_SOCIALBAR_INSTAGRAM', 'fa fa-instagram', 'TITLE_INSTAGRAM', '', 'DESC_SOCIALBAR_INSTAGRAM', 'form-control', '', 'PH_SOCIALBAR_INSTAGRAM', '', 316),
('socialBarTwitterUrl', '', 35, 1, 50, 'LABEL_SOCIALBAR_TWITTER', 'fa fa-twitter', 'TITLE_TWITTER', '', 'DESC_SOCIALBAR_TWITTER', 'form-control', '', 'PH_SOCIALBAR_TWITTER', '', 317),
('socialBarTumblrUrl', '', 35, 1, 60, 'LABEL_SOCIALBAR_TUMBLR', 'fa fa-tumblr', 'TITLE_TUMBLR', '', 'DESC_SOCIALBAR_TUMBLR', 'form-control', '', 'PH_SOCIALBAR_TUMBLR', '', 318),
('socialBarLinkedInUrl', '', 35, 1, 70, 'LABEL_SOCIALBAR_LINKEDIN', 'fa fa-linkedin', 'TITLE_LINKEDIN', '', 'DESC_SOCIALBAR_LINKEDIN', 'form-control', '', 'PH_SOCIALBAR_LINKEDIN', '', 319),
('socialBarXingUrl', '', 35, 1, 81, 'LABEL_SOCIALBAR_XING', 'fa fa-xing', 'TITLE_XING', '', 'DESC_SOCIALBAR_XING', 'form-control', '', 'PH_SOCIALBAR_XING', '', 320),
('socialBarGooglePlusUrl', '', 35, 1, 91, 'LABEL_SOCIALBAR_GOOGLEPLUS', 'fa fa-googleplus', 'TITLE_GOOGLEPLUS', '', 'DESC_SOCIALBAR_GOOGLEPLUS', 'form-control', '', 'PH_SOCIALBAR_GOOGLEPLUS_ICON', '', 321),
('socialBarFacebookIcon', 'fa fa-facebook-official', 35, 1, 2, 'LABEL_SOCIALBAR_FACEBOOK_ICON', '', '', '', 'DESC_SOCIALBAR_FACEBOOK_ICON', 'form-control', '', 'PH_SOCIALBAR_FACEBOOK_ICON', '', 322),
('socialBarYouTubeIcon', 'fa fa-youtube', 35, 1, 21, 'LABEL_SOCIALBAR_YOUTUBE_ICON', '', '', '', 'DESC_SOCIALBAR_YOUTUBE_ICON', 'form-control', '', 'PH_SOCIALBAR_YOUTUBE_ICON', '', 323),
('socialBarPinterestIcon', 'fa fa-pinterest', 35, 1, 31, 'LABEL_SOCIALBAR_PINTEREST_ICON', '', '', '', 'DESC_SOCIALBAR_PINTEREST_ICON', 'form-control', '', 'PH_SOCIALBAR_PINTEREST_ICON', '', 324),
('socialBarInstagramIcon', 'fa fa-instagram', 35, 1, 41, 'LABEL_SOCIALBAR_INSTAGRAM_ICON', '', '', '', 'DESC_SOCIALBAR_INSTAGRAM_ICON', 'form-control', '', 'PH_SOCIALBAR_INSTAGRAM_ICON', '', 325),
('socialBarTwitterIcon', 'fa fa-twitter', 35, 1, 51, 'LABEL_SOCIALBAR_TWITTER_ICON', '', '', '', 'DESC_SOCIALBAR_TWITTER_ICON', 'form-control', '', 'PH_SOCIALBAR_TWITTER_ICON', '', 326),
('socialBarTumblrIcon', 'fa fa-tumblr', 35, 1, 61, 'LABEL_SOCIALBAR_TUMBLR_ICON', '', '', '', 'DESC_SOCIALBAR_TUMBLR_ICON', 'form-control', '', 'PH_SOCIALBAR_TUMBLR_ICON', '', 327),
('socialBarLinkedInIcon', 'fa fa-linkedin', 35, 1, 71, 'LABEL_SOCIALBAR_LINKEDIN_ICON', '', '', '', 'DESC_SOCIALBAR_LINKEDIN_ICON', 'form-control', '', 'PH_SOCIALBAR_LINKEDIN_ICON', '', 328),
('socialBarXingIcon', 'fa fa-xing', 35, 1, 81, 'LABEL_SOCIALBAR_XING_ICON', '', '', '', 'DESC_SOCIALBAR_XING_ICON', 'form-control', '', 'PH_SOCIALBAR_XING_ICON', '', 329),
('socialBarGooglePlusIcon', 'fa fa-google-plus', 35, 1, 91, 'LABEL_SOCIALBAR_GOOGLEPLUS_ICON', '', '', '', 'DESC_SOCIALBAR_GOOGLEPLUS_ICON', 'form-control', '', 'PH_SOCIALBAR_GOOGLEPLUS_ICON', '', 330),
('socialBarFacebookColor', '', 35, 1, 3, 'LABEL_SOCIALBAR_FACEBOOK_COLOR', '', '', '', 'DESC_SOCIALBAR_COLOR', 'form-control', 'color', '', '', 331),
('socialBarYouTubeColor', '', 35, 1, 22, 'LABEL_SOCIALBAR_YOUTUBE_COLOR', '', '', '', 'DESC_SOCIALBAR_COLOR', 'form-control', 'color', '', '', 332),
('socialBarPinterestColor', '', 35, 1, 32, 'LABEL_SOCIALBAR_PINTEREST_COLOR', '', '', '', 'DESC_SOCIALBAR_COLOR', 'form-control', 'color', '', '', 333),
('socialBarInstagramColor', '', 35, 1, 42, 'LABEL_SOCIALBAR_INSTAGRAM_COLOR', '', '', '', 'DESC_SOCIALBAR_COLOR', 'form-control', 'color', '', '', 334),
('socialBarTwitterColor', '', 35, 1, 52, 'LABEL_SOCIALBAR_TWITTER_COLOR', '', '', '', 'DESC_SOCIALBAR_COLOR', 'form-control', 'color', '', '', 335),
('socialBarTumblrColor', '', 35, 1, 62, 'LABEL_SOCIALBAR_TUMBLR_COLOR', '', '', '', 'DESC_SOCIALBAR_COLOR', 'form-control', 'color', '', '', 336),
('socialBarLinkedInColor', '', 35, 1, 72, 'LABEL_SOCIALBAR_LINKEDIN_COLOR', '', '', '', 'DESC_SOCIALBAR_COLOR', 'form-control', 'color', '', '', 337),
('socialBarXingColor', '', 35, 1, 82, 'LABEL_SOCIALBAR_XING_COLOR', '', '', '', 'DESC_SOCIALBAR_COLOR', 'form-control', 'color', '', '', 338),
('socialBarGooglePlusColor', '', 35, 1, 92, 'LABEL_SOCIALBAR_GOOGLEPLUS_COLOR', '', '', '', 'DESC_SOCIALBAR_COLOR', 'form-control', 'color', '', '', 339),
('socialBarLinkTitle', 'follow me on', 35, 1, 0, 'LABEL_SOCIALBAR_LINKTITLE', '', '', '', 'DESC_SOCIALBAR_LINKTITLE', 'form-control', '', 'PH_SOCIALBAR_LINKTITLE', '', 340),
('socialBarLinkTarget', '_blank', 35, 1, 0, 'LABEL_SOCIALBAR_TARGET', '', '', '', 'DESC_SOCIALBAR_TARGET', 'form-control', 'select', '', '_self,_self (this window):_blank,_blank (new window):_parent,_parent (parent window)', 341),
('socialBarSize', 'H2', 35, 1, 0, 'LABEL_SOCIALBAR_SIZE', '', '', '', 'DESC_SOCIALBAR_SIZE', 'form-control', 'select', '', 'H1,H1:H2,H2:H3,H3:H4,H4:H5,H5:H6,H6:P,GLOBALTEXT', 342);
